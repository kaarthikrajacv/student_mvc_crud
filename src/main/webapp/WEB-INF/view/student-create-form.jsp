...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <div id="header">
        <h2 class=display-5 style="margin-left: 2px;">Student Create Form</h2>
      </div>
      <hr>
      <div id="container">
        <br>
        <h3 class=display-5 style="margin-left: 2px;">Form to Create Details</h3>
        <hr>
        <form:form class="" action="createStudent" method="post" modelAttribute="student">
          <form:hidden path="id" />
